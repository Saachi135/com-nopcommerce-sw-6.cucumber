...
//    }
    ...
    @And("^I verify text \"([^\"]*)\"$")
    public void iVerifyText(String name)  {
        new RegisterPage().inputFirstNameField(name);

    }

    @And("^I input first name \"([^\"]*)\"$")
    public void iInputFirstName(String arg0)  {

    }

    @And("^I input last name \"([^\"]*)\"$")
    public void iInputLastName(String name)  {
        new RegisterPage().lastNameField(name);

    }

    @And("^I input email address$")
    public void iInputEmailAddress() {
        new RegisterPage().emailField("gp12345@gmail.com");
    }
    ...
    @And("^I verify shopping cart title \"([^\"]*)\"$")
    public void iVerifyShoppingCartTitle(String arg0) {
